...
import { Box, Container, Grid, Skeleton, Card, CardContent, Stack } from '@mui/material';
      ...
      >
        <Container maxWidth="lg">
          <Grid container spacing={3}>
            ...
            <Grid item md={6} sx={{ display: { xs: 'none', md: 'block' }, zIndex: 1 }}>
              <Skeleton
                variant="rectangular"
                width="100%"
                height={400}
            ...
            <Grid item xs={12} md={4} key={index}>
              <Card elevation={2} sx={{ borderRadius: 4, height: '100%' }}>
                <CardContent>
                  ...
                  <Skeleton variant="rectangular" height={40} sx={{ width: '70%', borderRadius: 1 }} />
                </CardContent>
              </Card>
            </Grid>
          ))}
